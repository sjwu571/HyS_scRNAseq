####Save dimensions of UMAPs as 1212 x 1000#####
##Use max cutoff of q99 and RNA as default assay#####
...
##RFamide
FeaturePlot(seurat_integrated, "HyS0013.338", order = TRUE, cols = c("lightgrey", "magenta"), 
...
#HyS0049.55
FeaturePlot(seurat_integrated, "HyS0049.55", order = TRUE, cols = c("lightgrey", "yellow"), 
            min.cutoff = "q5", max.cutoff = "q99", slot = "data", pt.size = 2, label = FALSE) + labs(title = NULL) +
  theme(axis.text.x = element_text(face = "bold", size = 30, vjust = 0),
        axis.text.y = element_text(face = "bold", size = 30, hjust = 1),
        axis.title.y = element_text(face = "bold", size = 30),
