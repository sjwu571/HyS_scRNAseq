###Figure 6 v3_3 (use the RNA Assay for Featureplots, maxcutoff q99)
...
a <- c('lightgrey', 'lightgrey', 'lightgrey', 'lightgrey', 'lightgrey','#EBEB00', 'lightgrey')
...
#HyS0016.300_magenta
FeaturePlot(seurat_integrated, "HyS0016.300", order = TRUE, cols = c("lightgrey", "magenta"), 
